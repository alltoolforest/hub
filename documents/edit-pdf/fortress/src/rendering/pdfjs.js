...
function ensureNodeDomMatrix(){
  ...
  class DOMMatrixPolyfill{
    ...
    rotateSelf(){return this;} multiplySelf(){return this;} preMultiplySelf(){return this;} invertSelf(){return this;}
  }
  globalThis.DOMMatrix=DOMMatrixPolyfill;
}
export async function loadPdfjs(){ if(!promise){ensureNodeDomMatrix();promise=import('../../vendor/pdf.mjs');} return promise; }
